...
---
<hr class="main-hr">
<div class="main-head"><h4 class="main-head-h4"><a href="#about-us-link" class="main-link">ПРО НАС</a></h4><h4 class="main-head-h4"><a href="#our-mission-link" class="main-link">НАША МІСІЯ</a></h4><h4 class="main-head-h4"><a href="#community-center-link" class="main-link">ГРОМАДСЬКИЙ ЦЕНТР</a></h4><h4 class="main-head-h4"><a href="#issues-link" class="main-link">НАПРЯМИ РОБОТИ</a></h4><h4 class="main-head-h4"><a href="#footer-link" class="main-link">КОНТАКТИ</a></h4></div>
  ...
  <article>
          <div>
            ...
            <div class="blockContent" style="flex-direction: column;">
              ...
              <p class="paragraph">В основі нашої роботи лежить ідея розкриття потенціалу кожного громадянина. Ми віримо, що інвестиції в людський капітал - це найкраща інвестиція в майбутнє країни. Саме тому ми організовуємо освітні програми та тренінги, спрямовані на розвиток лідерських якостей, підприємницького мислення та навичок ефективної комунікації. Ми також проводимо спеціалізовані навчальні програми з написання грантів та надаємо підтримку переселенцям і ветеранам, допомагаючи їм отримати доступ до необхідних ресурсів та будувати нове життя.
              </p>
            </div>
            ...
            <div class="blockContent">
              ...
              <p class="paragraph">
                Місія громадської організації «Громадська синергія» - сприяти значущим змінам у розвитку громадянського суспільства в Україні шляхом просування формальної та неформальної освіти. Через освіту ми прагнемо розширити можливості людей стати активними учасниками у формуванні демократичного та інклюзивного суспільства.<br/><br/>
                Наше бачення ґрунтується на вірі в те, що ця місія може бути досягнута завдяки колективним зусиллям проактивних, соціально свідомих громадян. Об'єднавши тих, хто прагне прогресивних соціально-економічних змін, ми можемо створити суспільство, засноване на співпраці, стійкості та спільній відповідальності.<br/>
              </p>
            </div>
            ...
            <hr class="separator"/>
              <div class="blockContent">
                ...
                <p class="paragraph">
  Центр сталого розвитку громад ГО "Громадська синергія" надає експертну підтримку для сприяння зеленому переходу громад в Україні. Ми допомагаємо громадам розробляти та впроваджувати стратегії сталого розвитку, які вирішують економічні, соціальні та екологічні виклики.<br><br>
  Наш підхід зосереджений на розширенні можливостей громад, щоб вони стали стійкими та самодостатніми, популяризації екологічно дружніх практик та сприянні довгостроковій сталості. Завдяки адаптованій підтримці, семінарам і спільним проєктам ми прагнемо підвищити спроможність місцевих лідерів та жителів сприяти позитивним змінам заради сталого майбутнього.
                </p>
              </div>
              <h5 class="blockTitle" style=" text-align: left; font-size:30px; margin-top:0px;" id="issues-link">Наш досвід охоплює широке коло питань: </h5>
              <div class="blockContent">
